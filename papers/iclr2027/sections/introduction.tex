...
\begin{figure}[t]
  \centering
  \input{figures/birkhoff_collapse}
...
\begin{enumerate}
  ...
  \item \textbf{Neural ODE formulation with Lyapunov stability
    ...
    Neural ODE on $\mathcal{S}_r$.  The ODE achieves $2{,}656\%$ topological capacity
    relative to Sinkhorn (Section~\ref{sec:experiments_ode}), proving that
    collapse-free dynamics support diverse specialization topology.
