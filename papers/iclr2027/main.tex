...
implementation in PyTorch. Sinkhorn baseline used 20 iterations (matching the mHC
hyperparameter from \cite{xie2025mhc}). ODE solver used \texttt{torchdiffeq}
\texttt{dopri5} with \texttt{rtol=1e-3}, \texttt{atol=1e-6}.
